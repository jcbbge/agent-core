...
description: Load, access, and update Claude's persistent memory system across instantiations. Use when continuing past work, accessing previous insights, or adding new discoveries to the memory store.
---

# Claude Persistence Skill
