...
const PEER_MODELS: Record<string, { model: string; label: string }> = {
  // Verified live on Perplexity Responses API — 2026-06-02
  grok: { model: "xai/grok-4.20-reasoning", label: "Grok 4.20 Reasoning" },
  gemini: { model: "google/gemini-3.5-flash", label: "Gemini 3.5 Flash" },
  claude: { model: "anthropic/claude-4.7-opus", label: "Claude 4.7 Opus" },
};
