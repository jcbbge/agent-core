---
name: repo-deep-dive-analysis
description: Ingest external repositories to extract patterns and best practices, adapted to local context. Use when auditing codebases, learning from external repos, or extracting conventions. Triggers on 'analyze repo', 'deep dive', 'best practices from X'.
metadata:
  version: "1.0"
