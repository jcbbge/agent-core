...
description: VPS security hardening checklist with 10-minute emergency version. Use when setting up new servers or auditing security posture. Covers SSH hardening, UFW firewall, Fail2ban, automated updates, and backups.
metadata:
  version: "1.0"
