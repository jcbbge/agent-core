...
description: Deep performance and optimization analysis. Use when tuning slow code, finding bottlenecks, or refactoring for efficiency. Triggers on 'optimize this', 'make it faster', 'find inefficiencies'.
metadata:
  version: "1.0"
