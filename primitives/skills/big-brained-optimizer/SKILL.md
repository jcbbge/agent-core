...
description: Hyper-intensive performance optimization investigation. Finds gross inefficiencies where changes would provably move the needle on latency and throughput.
metadata:
  version: "1.0"
