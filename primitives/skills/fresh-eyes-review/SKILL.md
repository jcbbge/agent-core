...
description: Error detection and validation review from a fresh perspective. Use before finalizing plans, PRDs, or important documents. Triggers on 'check this for errors', 'fresh eyes', 'what did I miss', or pre-submit review requests.
metadata:
  version: "1.0"
