...
description: Behavior modifiers for agent interactions. Use to invoke [no artifacts], [results only], [default no files], and other bracket directives that change output format and response behavior.
metadata:
  version: "1.0"
