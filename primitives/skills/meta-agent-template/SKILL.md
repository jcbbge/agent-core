...
description: XML-based observer/testing agent template with strict role enforcement and cognitive framework. Use when creating agents with strict behavioral boundaries, testing agents, or observer/validator patterns.
metadata:
  version: "1.0"
